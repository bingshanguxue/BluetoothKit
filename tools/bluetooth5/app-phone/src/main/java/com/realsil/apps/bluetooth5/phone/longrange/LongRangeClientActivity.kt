...
import kotlinx.android.synthetic.main.phone_activity_longrange_receiver.*
import java.util.*
...
class LongRangeClientActivity : GattClientActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.phone_activity_longrange_receiver)
...
//            broadcastUpdate(BluetoothLeService.ACTION_DATA_AVAILABLE, characteristic)
            if (LongRangeSettings.getInstance()!!.isLongRangeClientLoopbackEnabled && mRxCharacteristic != null) {
