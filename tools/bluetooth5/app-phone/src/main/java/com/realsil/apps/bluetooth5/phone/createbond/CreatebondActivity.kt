package com.realsil.apps.bluetooth5.phone.createbond
...
import kotlinx.android.synthetic.main.phone_activity_create_bond.*
import java.util.*
...
class CreatebondActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.phone_activity_create_bond)
